...
examples:
  - name: List the Cassandra tables under an Azure Cosmos DB Cassandra keyspace (autogenerated)
    text: az cosmosdb cassandra table list --account-name MyAccount --keyspace-name MyKeyspace --resource-group MyResourceGroup --subscription MySubscription
    crafted: true
"""
...
aladdin_helps['eventhubs namespace network-rule remove'] = """
type: command
short-summary: Remove network rule for a namespace
examples:
  - name: Remove network rule for a namespace. (autogenerated)
    text: az eventhubs namespace network-rule remove --namespace-name mynamespace --resource-group myresourcegroup --subnet /subscriptions/{subscriptionid}/resourcegroups/{resourcegroupname}/providers/Microsoft.Network/virtualNetworks/{virtualnetworkname}/subnets/{subnetname} --vnet-name MyVnet
    crafted: true
"""
...
aladdin_helps['iot hub certificate delete'] = """
type: command
short-summary: Deletes an Azure IoT Hub certificate.
long-summary: For a detailed explanation of CA certificates in Azure IoT Hub, see https://docs.microsoft.com/azure/iot-hub/iot-hub-x509ca-overview
examples:
  - name: Deletes an Azure IoT Hub certificate. (autogenerated)
    text: az iot hub certificate delete --etag AAAAAAAAAAA= --hub-name MyIotHub --name MyCertificate --resource-group MyResourceGroup
    crafted: true
"""
...
examples:
  - name: Update a route in IoT Hub. (autogenerated)
    text: az iot hub route update --condition true --hub-name MyIotHub --resource-group MyResourceGroup --route-name R1
    crafted: true
"""
...
examples:
  - name: List all managed rule set. (autogenerated)
    text: az network application-gateway waf-policy managed-rule rule-set list --policy-name MyPolicy --resource-group MyResourceGroup --subscription MySubscription
    crafted: true
"""
...
examples:
  - name: Update properties of a web application firewall global configuration. (autogenerated)
    text: az network application-gateway waf-policy policy-setting update --mode Prevention --policy-name MyPolicy --resource-group MyResourceGroup
    crafted: true
  - name: Update properties of a web application firewall global configuration. (autogenerated)
...
aladdin_helps['network dns record-set aaaa update'] = """
type: command
short-summary: Update an AAAA record set.
examples:
  - name: Update an AAAA record set. (autogenerated)
    text: az network dns record-set aaaa update --name MyRecordSet --resource-group MyResourceGroup --set tags.CostCenter=MyBusinessGroup --zone-name www.mysite.com
    crafted: true
"""
...
examples:
  - name: Update peering settings of an ExpressRoute circuit. (autogenerated)
    text: az network express-route peering update --circuit-name MyCircuit --name MyPeering --peer-asn 10002 --resource-group MyResourceGroup
    crafted: true
  - name: Update peering settings of an ExpressRoute circuit. (autogenerated)
    text: az network express-route peering update --circuit-name MyCircuit --name MyPeering --resource-group MyResourceGroup --set useRemoteGateways=true
    crafted: true
"""
...
examples:
  - name: Update a traffic manager profile. (autogenerated)
    text: |
        az network traffic-manager profile update --name MyTmProfile --path "/"
    crafted: true
  - name: Update a traffic manager profile. (autogenerated)
    text: az network traffic-manager profile update --name MyTmProfile --resource-group MyResourceGroup --status Enabled
    crafted: true
"""
...
aladdin_helps['network vnet-gateway root-cert create'] = """
type: command
...
examples:
  - name: List all endpoints form a connection monitor. (autogenerated)
    text: az network watcher connection-monitor endpoint list --connection-monitor MyConnectionMonitor --location westus2
    crafted: true
"""
...
examples:
  - name: Show an endpoint from a connection monitor. (autogenerated)
    text: az network watcher connection-monitor endpoint show --connection-monitor MyConnectionMonitor --location westus2 --name MyConnectionMonitorEndpoint
    crafted: true
"""
...
examples:
  - name: List all output from a connection monitor. (autogenerated)
    text: az network watcher connection-monitor output list --connection-monitor MyConnectionMonitor --location westus2
    crafted: true
"""
...
examples:
  - name: List all test configurations of a connection monitor. (autogenerated)
    text: az network watcher connection-monitor test-configuration list --connection-monitor MyConnectionMonitor --location westus2
    crafted: true
"""
...
examples:
  - name: Show a test configuration from a connection monitor. (autogenerated)
    text: az network watcher connection-monitor test-configuration show --connection-monitor MyConnectionMonitor --location westus2 --name MyConnectionMonitorTestConfiguration
    crafted: true
"""
...
examples:
  - name: List all test groups of a connection monitor. (autogenerated)
    text: az network watcher connection-monitor test-group list --connection-monitor MyConnectionMonitor --location westus2
    crafted: true
"""
...
examples:
  - name: Show a test group of a connection monitor. (autogenerated)
    text: az network watcher connection-monitor test-group show --connection-monitor MyConnectionMonitor --location westus2 --name MyConnectionMonitorTestGroup
    crafted: true
"""
...
aladdin_helps['self-test'] = """
type: command
short-summary: Runs a self-test of the CLI.
examples:
  - name: Runs a self-test of the CLI. (autogenerated)
    text: az self-test --subscription MySubscription
    crafted: true
"""
...
aladdin_helps['group lock show'] = """
type: command
short-summary: Show the details of a resource group lock
examples:
  - name: Show the details of a resource group lock. (autogenerated)
    text: az group lock show --name lockname --resource-group MyResourceGroup --subscription MySubscription
    crafted: true
"""
...
examples:
  - name: Update an elastic pool. (autogenerated)
    text: az sql elastic-pool update --capacity 100 --edition Standard --family Gen4 --max-size 500GB --name mypool --resource-group mygroup --server myserver --zone-redundant true
    crafted: true
"""
...
examples:
  ...
  - name: Update a managed instance. (autogenerated)
    ...
    crafted: true
  - name: Update a managed instance. (autogenerated)
    text: az sql mi update --minimal-tls-version None --name myinstance --resource-group mygroup --subscription MySubscription
    crafted: true
"""
...
examples:
  - name: Remove a network rule. (autogenerated)
    ...
    crafted: true
  - name: Remove a network rule. (autogenerated)
    text: az storage account network-rule remove --account-name MyAccount --resource-group MyResourceGroup --subnet MySubnetID --vnet-name MyVnet
    crafted: true
"""
...
examples:
  - name: Place the CLI in a waiting state until a condition of a managed disk is met. (autogenerated)
    ...
    crafted: true
  - name: Place the CLI in a waiting state until a condition of a managed disk is met. (autogenerated)
    text: az disk wait --name MyManagedDisk --resource-group MyResourceGroup --updated
    crafted: true
"""
