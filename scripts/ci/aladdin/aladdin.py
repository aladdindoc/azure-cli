...
examples:
  - name: Get the properties of a specified agent pool for an Azure Container Registry. (autogenerated)
    text: az acr agentpool show --name MyAgentName --queue-count --registry MyRegistry
    crafted: true
"""
...
examples:
  - name: Update content-trust policy for an Azure Container Registry. (autogenerated)
    text: az acr config content-trust update --registry MyRegistry --status enabled --subscription mysubscription
    crafted: true
"""

aladdin_helps['acr config retention update'] = """
type: command
short-summary: Update retention policy for an Azure Container Registry.
examples:
  - name: Update retention policy for an Azure Container Registry. (autogenerated)
    text: az acr config retention update --days 0 --registry MyRegistry --resource-group myresourcegroup --status enabled --type UntaggedManifests
    crafted: true
"""
...
examples:
  - name: Update the registry login credential for a task. (autogenerated)
    text: az acr task credential update --login-server myregistry.docker.io --name taskname --password mysecret --registry registryname --subscription mysubscription --use-identity 00000000-0000-0000-0000-00000000000000000 --username myusername2
    crafted: true
"""
...
aladdin_helps['acr webhook ping'] = """
type: command
short-summary: Trigger a ping event for a webhook.
examples:
  - name: Trigger a ping event for a webhook (autogenerated)
    text: az acr webhook ping --name MyWebhook --registry MyRegistry --resource-group myresourcegroup
    crafted: true
"""
...
examples:
  - name: Wait for a container service to reach a desired state. (autogenerated)
    text: az acs wait --created --name mycontainerservice --resource-group myresourcegroup
    crafted: true
"""
...
examples:
  - name: Add a node pool to the managed Kubernetes cluster. (autogenerated)
    text: az aks nodepool add --cluster-name mycluster --kubernetes-version 1.16.9 --name mynodepool --node-count 7 --os-type Windows --resource-group myresourcegroup
    crafted: true
"""
...
examples:
  - name: Rotate certificates and keys on a managed Kubernetes cluster. (autogenerated)
    text: az aks rotate-certs --name mymanagedcluster --no-wait --resource-group myresourcegroup
    crafted: true
"""
...
examples:
  - name: Delete app service environment. (autogenerated)
    text: az appservice ase delete --name MyAseName --resource-group myresourcegroup --yes
    crafted: true
"""
...
examples:
  - name: Unbind a hostname from a function app. (autogenerated)
    text: az functionapp config hostname delete --hostname www.yourdomain.com --name myfunctionapp --resource-group myresourcegroup
    crafted: true
"""
...
examples:
  - name: Restore a web app snapshot. (autogenerated)
    text: az webapp config snapshot restore --name MySite --resource-group MyResourceGroup --slot staging --time 2018-12-11T23:34:16.8388367
    crafted: true
"""
...
long-summary: If an operation on a cluster was interrupted or was started with `--no-wait`, use this command to wait for it to complete.
examples:
  - name: Wait for a cluster to reach a desired state. (autogenerated)
    text: az aro wait --created --name mycluster --resource-group myresourcegroup
    crafted: true
"""
...
examples:
  - name: Update the policy associated with this item (autogenerated)
    text: az backup item set-policy --backup-management-type AzureIaasVM --container-name MyContainer --name MyItem --policy-name MyPolicy --resource-group MyResourceGroup --vault-name MyVault
    crafted: true
"""
...
examples:
  - name: Rehydrate an item from softdeleted state to stop protection with retained data state. (autogenerated)
    text: az backup protection undelete --backup-management-type AzureIaasVM --container-name MyContainer --item-name MyItem --resource-group MyResourceGroup --subscription mysubscription --vault-name MyVault
    crafted: true
"""
...
examples:
  - name: Shows details of a particular recovery point (autogenerated)
    text: az backup recoverypoint show --backup-management-type AzureIaasVM --container-name MyContainer --item-name MyItem --name MyRecoveryPoint --resource-group MyResourceGroup --subscription mysubscription --vault-name MyVault
    crafted: true
"""
...
examples:
  - name: List the start and end points of the unbroken log chain(s) of the given backup item (autogenerated)
    text: az backup recoverypoint show-log-chain --backup-management-type AzureIaasVM --container-name MyContainer --item-name MyItem --resource-group MyResourceGroup --vault-name MyVault
    crafted: true
"""
...
examples:
  - name: Create a new v4 SDK bot. (autogenerated)
    text: az bot create --appid myAppId --kind registration --location westus2 --name myresourcebot --password password --resource-group myresourcegroup
    crafted: true
"""
...
aladdin_helps['bot directline create'] = """
type: command
short-summary: Create the DirectLine Channel on a bot with only v3 protocol enabled.
examples:
  - name: Create the DirectLine Channel on a bot with only v3 protocol enabled. (autogenerated)
    text: az bot directline create --name botName --resource-group MyResourceGroup --subscription mysubscription
    crafted: true
"""
...
examples:
  - name: Get the throughput of the Gremlin graph under an Azure Cosmos DB Gremlin database. (autogenerated)
    text: az cosmosdb gremlin graph throughput show --account-name myaccount --database-name mydatabase --name mygrapth --resource-group myresourcegroup
    crafted: true
"""
...
examples:
  - name: List the private link resources supported for Azure Comsos DB. (autogenerated)
...
examples:
  - name: Stop an instance of the Data Migration Service (autogenerated)
    text: az dms stop --name myservice --resource-group myresourcegroup --subscription mysubscription
    crafted: true
"""
...
examples:
  - name: Show details of a linked IoT hub in an Azure IoT Hub device provisioning service. (autogenerated)
    text: az iot dps linked-hub show --dps-name MyDps --linked-hub MyLinkedHub --resource-group MyResourceGroup --subscription mysubscription
    crafted: true
"""
...
examples:
  - name: Create a message enrichment for chosen endpoints in your IoT Hub. (autogenerated)
    text: az iot hub message-enrichment create --endpoints events --key key --name new-policy --resource-group myresourcegroup --subscription mysubscription --value value
    crafted: true
"""
...
examples:
  - name: Delete a message enrichment in your IoT hub (by key). (autogenerated)
    text: az iot hub message-enrichment delete --key test --name new-policy --resource-group myresourcegroup
    crafted: true
"""
...
examples:
  - name: Get information on all message enrichments for your IoT Hub. (autogenerated)
...
examples:
  - name: Update a message enrichment in your IoT hub (by key). (autogenerated)
    text: az iot hub message-enrichment update --endpoints NewEndpoint1 NewEndpoint2 --key test --name new-policy --resource-group myresourcegroup --subscription mysubscription --value value
    crafted: true
"""
...
examples:
  - name: List the private link resources supported for a Key Vault. (autogenerated)
    text: az keyvault private-link-resource list --resource-group myresourcegroup --vault-name mykv
    crafted: true
"""
...
examples:
  - name: Update the properties of a key vault. (autogenerated)
    ...
    crafted: true
  - name: Update the properties of a key vault. (autogenerated)
    text: az keyvault update --enable-soft-delete true --name MyKeyVault
    crafted: true
"""
...
examples:
  - name: Delete a Kusto cluster. (autogenerated)
    text: az kusto cluster delete --name mycluster --resource-group myresourcegroup --subscription mysubscription --yes
    crafted: true
"""
...
examples:
  - name: Update the details of this activity log alert (autogenerated)
    ...
    crafted: true
  - name: Update the details of this activity log alert. (autogenerated)
    text: az monitor activity-log alert update --name MyActivityLogAlerts --resource-group MyResourceGroup --set retentionPolicy.days=365
    crafted: true
"""
...
examples:
  - name: Update diagnostic settings. (autogenerated)
    text: az monitor diagnostic-settings update --name MyDiagnosticSetting --resource myScaleSet --resource-group myresourcegroup --resource-type microsoft.logic/workflows --set retentionPolicy.days=365
    crafted: true
"""
...
examples:
  - name: Create a cluster instance. (autogenerated)
    text: az monitor log-analytics cluster create --name MyCluster --no-wait --resource-group MyResourceGroup --sku-capacity 1000 --tags key[=value]
    crafted: true
"""
...
examples:
  - name: List all linked storage accounts for a log analytics workspace. (autogenerated)
    text: az monitor log-analytics workspace linked-storage list --resource-group MyResourceGroup --subscription mysubscription --workspace-name MyWorkspace
    crafted: true
"""
...
examples:
  - name: Update a workspace instance. (autogenerated)
    text: az monitor log-analytics workspace update --resource-group myresourcegroup --workspace-name myworkspace
    crafted: true
"""
...
examples:
  - name: Update a NAT gateway. (autogenerated)
    text: az network nat gateway update --name MyNatGateway --resource-group MyResourceGroup --set useRemoteGateways=true
    crafted: true
"""
...
aladdin_helps['netappfiles volume update'] = """
type: command
...
parameters:
  ...
  - name: --tags
    short-summary: Space-separated tags in `key[=value]` format
examples:
  - name: Update the specified ANF volume with the values provided (autogenerated)
    text: az netappfiles volume update --account-name myaccname --pool-name mypoolname --protocol-types NFSv3 NFSv4.1 --resource-group mygroup --volume-name myvolname
    crafted: true
"""
...
examples:
  - name: Create HTTP settings. (autogenerated)
    ...
    crafted: true
  - name: Create HTTP settings. (autogenerated)
    text: az network application-gateway http-settings create --cookie-based-affinity Enabled --enable-probe true --gateway-name MyAppGateway --host-name MyHost --name MyHttpSettings --port 80 --probe MyNewProbe --protocol Http --resource-group MyResourceGroup --timeout 30
    crafted: true
"""
...
examples:
  - name: Update a probe. (autogenerated)
    ...
    crafted: true
  - name: Update a probe. (autogenerated)
    text: az network application-gateway probe update --gateway-name MyAppGateway --name MyProbe --path /path/to/probe --resource-group MyResourceGroup
    crafted: true
"""
...
examples:
  - name: Delete a rewrite rule. (autogenerated)
    text: az network application-gateway rewrite-rule delete --gateway-name MyGateway --name MyRewriteRule --resource-group MyResourceGroup --rule-set-name MyRuleSet --subscription mysubscription
    crafted: true
"""
...
examples:
  - name: Create an application gateway WAF policy custom rule. (autogenerated)
    text: az network application-gateway waf-policy custom-rule create --action Allow --name mywafpolicyrule --policy-name mypolicy --priority 500 --resource-group myresourcegroup --rule-type MatchRule --subscription mysubscription
    crafted: true
"""
...
examples:
  - name: Delete an application gateway WAF policy custom rule. (autogenerated)
    text: az network application-gateway waf-policy custom-rule delete --name mywafpolicyrule --policy-name mypolicy --resource-group myresourcegroup --subscription mysubscription
    crafted: true
"""
...
examples:
  - name: Update an application gateway WAF policy custom rule. (autogenerated)
    ...
    crafted: true
  - name: Update an application gateway WAF policy custom rule. (autogenerated)
    text: az network application-gateway waf-policy custom-rule update --action Allow --name MyWAFPolicyRule --policy-name MyPolicy --resource-group MyResourceGroup
    crafted: true
"""
...
examples:
  - name: Add managed rule set to the WAF policy managed rules (autogenerated)
    text: az network application-gateway waf-policy managed-rule rule-set add --policy-name mypolicy --resource-group myresourcegroup --type Microsoft_BotManagerRuleSet --version 0.1
    crafted: true
"""
...
examples:
  - name: Update properties of a web application firewall global configuration. (autogenerated)
    text: az network application-gateway waf-policy policy-setting update --mode Prevention --policy-name MyPolicy --resource-group MyResourceGroup --state Disabled
    crafted: true
"""
...
examples:
  - name: Update an application gateway WAF policy. (autogenerated)
    ...
    crafted: true
  - name: Update an application gateway WAF policy. (autogenerated)
    text: az network application-gateway waf-policy update --add communities='12076:5010' --name MyApplicationGatewayWAFPolicy --resource-group MyResourceGroup --subscription mysubscription
    crafted: true
"""
...
examples:
  - name: Create an empty MX record set. (autogenerated)
    text: az network dns record-set mx create --metadata owner=WebTeam --name MyRecordSet --resource-group MyResourceGroup --ttl 30 --zone-name www.mysite.com
    crafted: true
"""
...
examples:
  - name: Create a new link authorization for an ExpressRoute circuit. (autogenerated)
    text: az network express-route auth create --circuit-name MyCircuit --name MyAuthorization --resource-group MyResourceGroup --subscription mysubscription
    crafted: true
"""
...
examples:
  - name: Update peering settings of an ExpressRoute circuit. (autogenerated)
    ...
    crafted: true
  - name: Update peering settings of an ExpressRoute circuit. (autogenerated)
    text: az network express-route peering update --circuit-name MyCircuit --ip-version IPv4 --name MyPeering --peer-asn 10002 --primary-peer-subnet 2002:db00::/126 --resource-group MyResourceGroup --secondary-peer-subnet 2003:db00::/126 --vlan-id 103
    crafted: true
"""
...
examples:
  - name: Update settings of an ExpressRoute port. (autogenerated)
    text: az network express-route port update --name MyExpressRoutePort --resource-group MyResourceGroup --set useRemoteGateways=true
    crafted: true
"""
...
examples:
  - name: Update a load balancing rule. (autogenerated)
    ...
    crafted: true
  - name: Update a load balancing rule. (autogenerated)
    text: az network lb rule update --enable-tcp-reset true --lb-name MyLb --name MyLbRule --resource-group MyResourceGroup
    crafted: true
"""
...
examples:
  - name: List rules in a route filter. (autogenerated)
    text: az network route-filter rule list --filter-name MyRouteFilter --resource-group MyResourceGroup --subscription mysubscription
    crafted: true
"""
...
examples:
  - name: Update a route in a route table. (autogenerated)
    ...
    crafted: true
  - name: Update a route in a route table. (autogenerated)
    text: az network route-table route update --name MyRoute --next-hop-ip-address 10.0.100.5 --resource-group MyResourceGroup --route-table-name MyRouteTable --subscription mysubscription
    crafted: true
"""
...
examples:
  - name: Update a route table. (autogenerated)
    text: az network route-table update --name MyRouteTable --resource-group MyResourceGroup --set useRemoteGateways=true
    crafted: true
"""
...
examples:
  ...
  - name: Update a traffic manager profile. (autogenerated)
    ...
    crafted: true
  - name: Update a traffic manager profile. (autogenerated)
    text: az network traffic-manager profile update --name MyTmProfile --resource-group MyResourceGroup --routing-method Performance
    crafted: true
"""
...
examples:
  - name: Lists deployments for a resource policy remediation. (autogenerated)
    text: az policy remediation deployment list --name myremediation
    crafted: true
"""
...
examples:
  - name: Create an empty CNAME record set (autogenerated)
    text: az network private-dns record-set cname create --name MyRecordSet --resource-group MyResourceGroup --subscription mysubscription --ttl 300 --zone-name www.mysite.com
    crafted: true
"""
...
examples:
  - name: Get the details of a CNAME record set. (autogenerated)
    text: az network private-dns record-set cname show --name MyRecordSet --resource-group MyResourceGroup --subscription mysubscription --zone-name www.mysite.com
    crafted: true
"""
...
aladdin_helps['mariadb server firewall-rule create'] = """
type: command
short-summary: Create a new firewall rule for a server.
examples:
  - name: Create a new firewall rule for a server. (autogenerated)
    text: az mariadb server firewall-rule create --end-ip-address 107.46.14.221 --name allowip --resource-group testgroup --server-name testsvr --start-ip-address 107.46.14.0 --subscription mysubscription
    crafted: true
"""
...
examples:
  - name: Restart a server. (autogenerated)
    text: az mariadb server restart --name testsvr --resource-group testgroup --subscription mysubscription
    crafted: true
"""
...
examples:
  ...
  - name: Update a server. (autogenerated)
    ...
    crafted: true
  - name: Update a server. (autogenerated)
    text: az mariadb server update --name testsvrnew --public-network-access Enabled --resource-group testgroup
    crafted: true
"""
...
aladdin_helps['mariadb server-logs download'] = """
type: command
short-summary: Download log files.
examples:
  - name: Download log files. (autogenerated)
    text: az mariadb server-logs download --name f1.log f2.log --resource-group testgroup --server-name testsvr --subscription mysubscription
    crafted: true
"""
...
examples:
  - name: Get Active Directory Administrator information for a PostgreSQL server (autogenerated)
    text: az postgres server ad-admin show --resource-group testgroup --server-name testsvr --subscription mysubscription
    crafted: true
"""
...
aladdin_helps['postgres server private-link-resource list'] = """
type: command
short-summary: List the private link resources supported for a PostgreSQL server.
examples:
  - name: List the private link resources supported for a PostgreSQL server. (autogenerated)
    text: az postgres server private-link-resource list --resource-group myresourcegroup --server-name myserver
    crafted: true
"""
...
examples:
  - name: Update a Redis cache. (autogenerated)
    text: az redis update --name myrediscache --resource-group myresourcegroup --vm-size c0
    crafted: true
"""
...
examples:
  - name: Cancel a deployment at subscription scope. (autogenerated)
    text: az deployment sub cancel --name deployment01 --subscription mysubscription
    crafted: true
"""
...
examples:
  - name: Validate whether a template is valid at tenant scope. (autogenerated)
    text: az deployment tenant validate --location WestUS --name mydeployment --template-file azuredeploy.json
    crafted: true
"""
...
examples:
  - name: Export the template used for a deployment. (autogenerated)
    text: az group deployment export --name MyDeployment --resource-group MyResourceGroup --subscription mysubscription
    crafted: true
"""
...
examples:
  - name: Delete a managed application. (autogenerated)
    text: az managedapp delete --name MyManagedApplication --resource-group MyResourceGroup --subscription mysubscription
    crafted: true
"""
...
examples:
  - name: Creates a workspace settings in your subscription - these settings let you control which workspace will hold your security data. (autogenerated)
    text: az security workspace-setting create --name default --subscription mysubscription --target-workspace '/subscriptions/00000000-0000-0000-0000-00000000000000000/resourceGroups/myRg/providers/Microsoft.OperationalInsights/workspaces/myWorkspace'
    crafted: true
"""
...
examples:
  - name: Updates existing Service Bus Queue. (autogenerated)
    text: az servicebus queue update --enable-session true --name myqueue --namespace-name mynamespace --resource-group myresourcegroup --status Active
    crafted: true
"""
...
examples:
  ...
  - name: Updates the Service Bus Topic (autogenerated)
    ...
    crafted: true
  - name: Updates the Service Bus Topic. (autogenerated)
    text: az servicebus topic update --name mytopic --namespace-name mynamespace --resource-group myresourcegroup --status Active
    crafted: true
"""
...
examples:
  - name: Update the durability tier or VM SKU of a node type in the cluster. (autogenerated)
    text: az sf cluster durability update --cluster-name cluster1 --durability-level Bronze --node-type nt1 --resource-group group-name --subscription mysubscription
    crafted: true
"""
...
examples:
  - name: Create a copy of a database. (autogenerated)
    text: az sql db copy --dest-name newDb --dest-resource-group mygroup --dest-server myserver --name originalDb --resource-group mygroup --server myserver
    crafted: true
"""
...
examples:
  - name: Create a data warehouse. (autogenerated)
    text: az sql dw create --collation Latin1_General_100_CS_AS_SC --name MyDataWarehouse --resource-group MyResourceGroup --server myserver --service-objective S0 --subscription mysubscription
    crafted: true
"""
...
examples:
  - name: List available instance pools. (autogenerated)
    text: az sql instance-pool list --subscription mysubscription
    crafted: true
"""
...
examples:
  - name: Returns a list of managed instance Active Directory Administrators. (autogenerated)
    text: az sql mi ad-admin list --managed-instance myinstance --resource-group myresourcegroup --subscription mysubscription
    crafted: true
"""
...
examples:
  ...
  - name: Update a managed instance. (autogenerated)
    ...
    crafted: true
  - name: Update a managed instance. (autogenerated)
    text: az sql mi update --minimal-tls-version None --name myinstance --resource-group mygroup
    crafted: true
"""
...
aladdin_helps['storage account file-service-properties update'] = """
type: command
...
examples:
  - name: Update the properties of file service in storage account. (autogenerated)
    text: az storage account file-service-properties update --account-name mystorageaccount --delete-retention-days 100 --enable-delete-retention true --only-show-errors
    crafted: true
"""
...
examples:
  - name: Updates the data policy rules associated with the specified storage account. (autogenerated)
    text: az storage account management-policy update --account-name myaccount --force-string --resource-group myresourcegroup
    crafted: true
"""
...
examples:
  - name: Mark a blob or snapshot for deletion. (autogenerated)
    text: az storage blob delete --account-key 00000000 --account-name mystorageaccount --container-name mycontainer --name MyBlob
    crafted: true
"""
...
examples:
  - name: Create file system for Azure Data Lake Storage Gen2 account. (autogenerated)
    text: az storage fs create --account-name mystorageaccount --auth-mode login --name fsname
    crafted: true
"""
...
examples:
  - name: Delete a directory in ADLS Gen2 file system. (autogenerated)
    text: az storage fs directory delete --account-name myadlsaccount --auth-mode login --file-system myfilesystem --name dir
    crafted: true
"""
...
examples:
  - name: List file systems in ADLS Gen2 account. (autogenerated)
    text: az storage fs list --account-name myadlsaccount --auth-mode login
    crafted: true
"""
...
examples:
  - name: Show properties of file system in ADLS Gen2 account. (autogenerated)
    text: az storage fs show --account-name myadlsaccount --auth-mode login --name myfilesystem
    crafted: true
"""
...
examples:
  - name: Create a proximity placement group. (autogenerated)
    text: az ppg create --location westus2 --name MyProximityPlacementGroup --resource-group MyResourceGroup
    crafted: true
"""
...
examples:
  - name: Create a dedicated host (autogenerated)
    text: az vm host create --auto-replace true --host-group my-host-group --license-type None --location eastasia --name my-host --resource-group my-resource-group --sku DSv3-Type1
    crafted: true
"""
